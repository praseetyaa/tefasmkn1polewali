  ...
  <div class="container">
    ...
    <div class="header-icon">
      ...
      <a class="whishlist" href="<?php echo esc_url( top_store_whishlist_url() ); ?>">
        <span class="th-whishlist-text"><?php _e('Favorit','top-store');?></span> <span><?php _e('Wishlist','top-store');?></span><i  class="fa fa-heart-o" aria-hidden="true"></i></a>
        
        <?php endif; }
        elseif($whs_icon == false){?>
        <a class="whishlist" href="<?php echo esc_url( top_store_whishlist_url() ); ?>">
          <span class="th-whishlist-text"><?php _e('Favorit','top-store');?></span>
