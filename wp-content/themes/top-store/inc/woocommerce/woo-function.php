...
<a class="account" href="<?php echo esc_url(get_permalink( get_option('woocommerce_myaccount_page_id') ));?>"><span class="account-text"><?php _e('Halo , ','top-store');?> <?php top_store_display_admin_name(); ?></span><span class="account-text"><?php _e('Akun Saya','top-store');?></span><i class="fa fa-user-o" aria-hidden="true"></i></a>
<?php } else {?>
<span><a href="<?php echo esc_url(get_permalink( get_option('woocommerce_myaccount_page_id') ));?>"><span class="account-text"><?php _e('Login / Signup','top-store');?></span><span class="account-text"><?php _e('Akun Saya','top-store');?></span><i class="fa fa-lock" aria-hidden="true"></i></a></span>
<?php }
 }
